...
class UCk_EntityScript_AttributeGym_ByteMinMaxCurrent : UCk_GenericEntityScript_UE
{
		...
		FCk_Handle& InHandle)
	{
		...
		AutoConfig.ManualCommands.Add("panel [7] Min preset · [8] Max preset · [9] Current preset");
