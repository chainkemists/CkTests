...
class UCk_EntityScript_AttributeGym_FloatMultiple : UCk_EntityScript_UE
{
	...
	Request_TestForEachOperations()
	{
		...
		auto AllFound = utils_float_attribute::ForEach(SelfEntity, FInstancedStruct(),
	...
	Request_UpdateDisplay()
	{
		...
		auto Instructions = "Creates multiple attributes in batches and demonstrates ForEach iteration patterns.\n"
            ...
            + "across attribute collections with fractional values.";
