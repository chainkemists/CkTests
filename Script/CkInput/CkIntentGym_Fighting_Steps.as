...
//============================================================================
// CK INTENT FIGHTING GYM — STATION STEP STATES
//============================================================================
//
...
// somebody was still mid-motion, which is the one thing a human-driven station
...
// transitions", driven externally by Request_Transition).
//
...
UCLASS()
class UCk_IntentGym_Step_Counter_Arm : UCk_Gym_StepState
{
...
UCLASS()
class UCk_IntentGym_Step_Counter_Await : UCk_Gym_StepState
{
    UFUNCTION(BlueprintOverride)
    void DoDefineState(FCk_Handle_SmState_UnderConstruction& InHandle)
    {
...
UCLASS()
class UCk_IntentGym_Step_Counter_Report : UCk_Gym_StepState
{
    UFUNCTION(BlueprintOverride)
    void DoDefineState(FCk_Handle_SmState_UnderConstruction& InHandle)
    {
...
//----------------------------------------------------------------------------
// Station 2 — deferred versus instant
//----------------------------------------------------------------------------

UCLASS()
class UCk_IntentGym_Step_Contrast_Arm : UCk_Gym_StepState
{
    UFUNCTION(BlueprintOverride)
    void DoDefineState(FCk_Handle_SmState_UnderConstruction& InHandle)
    {
...
UCLASS()
class UCk_IntentGym_Step_Contrast_Await : UCk_Gym_StepState
{
    UFUNCTION(BlueprintOverride)
    void DoDefineState(FCk_Handle_SmState_UnderConstruction& InHandle)
    {
...
UCLASS()
class UCk_IntentGym_Step_Contrast_Report : UCk_Gym_StepState
{
    UFUNCTION(BlueprintOverride)
    void DoDefineState(FCk_Handle_SmState_UnderConstruction& InHandle)
    {
...
UCLASS()
class UCk_IntentGym_Step_NearMiss_Arm : UCk_Gym_StepState
{
    UFUNCTION(BlueprintOverride)
    void DoDefineState(FCk_Handle_SmState_UnderConstruction& InHandle)
    {
...
UCLASS()
class UCk_IntentGym_Step_NearMiss_Await : UCk_Gym_StepState
{
    UFUNCTION(BlueprintOverride)
    void DoDefineState(FCk_Handle_SmState_UnderConstruction& InHandle)
    {
...
UCLASS()
class UCk_IntentGym_Step_NearMiss_Report : UCk_Gym_StepState
{
    UFUNCTION(BlueprintOverride)
    void DoDefineState(FCk_Handle_SmState_UnderConstruction& InHandle)
    {
