...
const float k_CelGym_ViewingClearance = 600.0f;
...
class ACk_UsfStylizeCelGym_PlayerController : ACk_Gym_Base_PlayerController
{
    ...
    TArray<FCkGym_Station_SpawnParams_Payload> Get_RequiredStations() override
    {
        ...
        const float StationRowX = 1800.0f + k_CelGym_ViewingClearance;
    ...
    private FVector Get_StationViewingPoint(FName InTag)
    {
        ...
        return Xf.Location + Xf.Rotator().GetForwardVector() * k_CelGym_ViewingClearance;
    }
