...
//
// Set this class as the World Settings default game mode in the CkGym_AllTests
// level. Individual gyms override via ServerTravel's ?game= parameter, and
// their specific game modes also inherit from here.
//--------------------------------------------------------------------------------------------------------------------------
