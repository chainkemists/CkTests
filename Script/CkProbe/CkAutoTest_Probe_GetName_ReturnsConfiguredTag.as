...
class UCk_AutoTest_Probe_GetName_ReturnsConfiguredTag : UCk_AutoTest_Base
{
    ...
    void DoBeginPlay(FCk_Handle InHandle)
    {
        ...
        auto ProbeParams = FCk_Fragment_Probe_ParamsData(ConfiguredTag);
        ...
        Assert_True(ReturnedTag == ConfiguredTag,
            f"Get_Name should return the tag passed to the FCk_Fragment_Probe_ParamsData constructor (configured: AutoTest.Probe.GetName.SpecificValue)");
