...
USTRUCT()
struct FCk_AutoTest_BallisticMotion_ArcFollowsClosedForm_SpawnParams
{
}

namespace UCk_AutoTest_BallisticMotion_ArcFollowsClosedForm
{
    FCk_AutoTest_BallisticMotion_ArcFollowsClosedForm_SpawnParams Params()
    {
        return FCk_AutoTest_BallisticMotion_ArcFollowsClosedForm_SpawnParams();
    }
}

USTRUCT()
struct FCk_AutoTest_BallisticMotion_FastForwardEquivalence_SpawnParams
{
}

namespace UCk_AutoTest_BallisticMotion_FastForwardEquivalence
{
    FCk_AutoTest_BallisticMotion_FastForwardEquivalence_SpawnParams Params()
    {
        return FCk_AutoTest_BallisticMotion_FastForwardEquivalence_SpawnParams();
    }
}

USTRUCT()
struct FCk_AutoTest_BallisticMotion_ImpactStopsProjectile_SpawnParams
{
}

namespace UCk_AutoTest_BallisticMotion_ImpactStopsProjectile
{
    FCk_AutoTest_BallisticMotion_ImpactStopsProjectile_SpawnParams Params()
    {
        return FCk_AutoTest_BallisticMotion_ImpactStopsProjectile_SpawnParams();
    }
}
...
USTRUCT()
struct FCk_AutoTest_LagCompProjectile_CompensatedLaunchHitsPastPose_SpawnParams
{
}

namespace UCk_AutoTest_LagCompProjectile_CompensatedLaunchHitsPastPose
{
    FCk_AutoTest_LagCompProjectile_CompensatedLaunchHitsPastPose_SpawnParams Params()
    {
        return FCk_AutoTest_LagCompProjectile_CompensatedLaunchHitsPastPose_SpawnParams();
    }
}
...
USTRUCT()
struct FCk_AutoTest_Net_RewindHistory_RecordsOnAuthorityOnly_SpawnParams
{
}

namespace UCk_AutoTest_Net_RewindHistory_RecordsOnAuthorityOnly
{
    FCk_AutoTest_Net_RewindHistory_RecordsOnAuthorityOnly_SpawnParams Params()
    {
        return FCk_AutoTest_Net_RewindHistory_RecordsOnAuthorityOnly_SpawnParams();
    }
}
...
USTRUCT()
struct FCk_AutoTest_RewindHistory_RewindFindsPastPose_SpawnParams
{
}

namespace UCk_AutoTest_RewindHistory_RewindFindsPastPose
{
    FCk_AutoTest_RewindHistory_RewindFindsPastPose_SpawnParams Params()
    {
        return FCk_AutoTest_RewindHistory_RewindFindsPastPose_SpawnParams();
    }
}
...
USTRUCT()
struct FCk_EntityScript_GoapGym_CombatBrain_Station_SpawnParams
{
    UPROPERTY()
    FTransform InitialTransform = FTransform::Identity;

    FCk_EntityScript_GoapGym_CombatBrain_Station_SpawnParams(FTransform InInitialTransform)
    {
        InitialTransform = InInitialTransform;
    }
}

namespace UCk_EntityScript_GoapGym_CombatBrain_Station
{
    FCk_EntityScript_GoapGym_CombatBrain_Station_SpawnParams Params()
    {
        return FCk_EntityScript_GoapGym_CombatBrain_Station_SpawnParams();
    }

    FCk_EntityScript_GoapGym_CombatBrain_Station_SpawnParams Params(FTransform InInitialTransform)
    {
        return FCk_EntityScript_GoapGym_CombatBrain_Station_SpawnParams(InInitialTransform);
    }
}
