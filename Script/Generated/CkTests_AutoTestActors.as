...
class ACk_AutoTest_EntityPool_ArchetypePool_InheritsAuthoredValues_Actor : ACk_AutoTestRunner
{
    default _TimeoutSeconds = 8.0f;
    UFUNCTION(BlueprintOverride)
    TSubclassOf<UCk_EntityScript_UE> Get_TestEntityScriptClass() const
    {
        auto Path = FSoftClassPath("/Script/Angelscript.Ck_AutoTest_EntityPool_ArchetypePool_InheritsAuthoredValues");
        TSubclassOf<UCk_EntityScript_UE> ResolvedClass;
        ResolvedClass = Path.TryLoadClass();
        return ResolvedClass;
    }
...
class ACk_AutoTest_EntityPool_Perf_RampTo1000_GrowBatchPreProvisions_Actor : ACk_AutoTestRunner
{
    default _TimeoutSeconds = 120.0f;
    UFUNCTION(BlueprintOverride)
    TSubclassOf<UCk_EntityScript_UE> Get_TestEntityScriptClass() const
    {
        auto Path = FSoftClassPath("/Script/Angelscript.Ck_AutoTest_EntityPool_Perf_RampTo1000_GrowBatchPreProvisions");
        TSubclassOf<UCk_EntityScript_UE> ResolvedClass;
        ResolvedClass = Path.TryLoadClass();
        return ResolvedClass;
    }
...
class ACk_AutoTest_EntityPool_Perf_SpawnVsPoolReuse_Actor : ACk_AutoTestRunner
{
    ...
    TSubclassOf<UCk_EntityScript_UE> Get_TestEntityScriptClass() const
    {
        auto Path = FSoftClassPath("/Script/Angelscript.Ck_AutoTest_EntityPool_Perf_SpawnVsPoolReuse");
        TSubclassOf<UCk_EntityScript_UE> ResolvedClass;
        ResolvedClass = Path.TryLoadClass();
        return ResolvedClass;
    }
...
class ACk_AutoTest_EntityPool_ReceiverRoundTrip_Actor : ACk_AutoTestRunner
{
    ...
    TSubclassOf<UCk_EntityScript_UE> Get_TestEntityScriptClass() const
    {
        auto Path = FSoftClassPath("/Script/Angelscript.Ck_AutoTest_EntityPool_ReceiverRoundTrip");
        TSubclassOf<UCk_EntityScript_UE> ResolvedClass;
        ResolvedClass = Path.TryLoadClass();
        return ResolvedClass;
    }
...
class ACk_AutoTest_EntityPool_ReceiverVetoDestroys_Actor : ACk_AutoTestRunner
{
    default _TimeoutSeconds = 8.0f;
    UFUNCTION(BlueprintOverride)
    TSubclassOf<UCk_EntityScript_UE> Get_TestEntityScriptClass() const
    {
        auto Path = FSoftClassPath("/Script/Angelscript.Ck_AutoTest_EntityPool_ReceiverVetoDestroys");
        TSubclassOf<UCk_EntityScript_UE> ResolvedClass;
        ResolvedClass = Path.TryLoadClass();
        return ResolvedClass;
    }
...
class ACk_AutoTest_ObjectPool_ReceiverActorRoundTripAndVeto_Actor : ACk_AutoTestRunner
{
    UFUNCTION(BlueprintOverride)
    TSubclassOf<UCk_EntityScript_UE> Get_TestEntityScriptClass() const
    {
        auto Path = FSoftClassPath("/Script/Angelscript.Ck_AutoTest_ObjectPool_ReceiverActorRoundTripAndVeto");
        TSubclassOf<UCk_EntityScript_UE> ResolvedClass;
        ResolvedClass = Path.TryLoadClass();
        return ResolvedClass;
    }
