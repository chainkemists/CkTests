...
// _LookAtTarget, resolved as the dominant layer's look-at and fed into the POV pipeline). Orientation control is
// off — the camera tracks the target, not the player's stick.
//============================================================================
