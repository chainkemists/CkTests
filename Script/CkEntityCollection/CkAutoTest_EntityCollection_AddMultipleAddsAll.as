...
class UCk_AutoTest_EntityCollection_AddMultipleAddsAll : UCk_AutoTest_Base
{
    ...
    void DoBeginPlay(FCk_Handle InHandle)
    {
        ...
        auto ParamsList = TArray<FCk_EntityCollection_Spec>();
        ParamsList.Add(FCk_EntityCollection_Spec(NameA));
        ParamsList.Add(FCk_EntityCollection_Spec(NameB));

        auto Added = utils_entity_collection::AddMultiple(
            LocalHandle,
            FCk_MultipleEntityCollection_Spec(ParamsList),
