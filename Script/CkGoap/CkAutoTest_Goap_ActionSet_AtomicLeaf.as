...
class UCk_AutoTest_Goap_ActionSet_AtomicLeaf : UCk_AutoTest_Base
{
    ...
    void DoBeginPlay(FCk_Handle InHandle)
    {
        ...
        auto ChildAction = utils_goap_action::AddAction_ToAction(_RootAction, ChildParams);
        Assert_True(ck::IsValid(ChildAction), "AddAction_ToAction should return a valid handle");
...
class ACk_AutoTest_Goap_ActionSet_AtomicLeaf_Actor : ACk_AutoTestRunner
{
    default _TestEntityScriptClass = UCk_AutoTest_Goap_ActionSet_AtomicLeaf;
}
