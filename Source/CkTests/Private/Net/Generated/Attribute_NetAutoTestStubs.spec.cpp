...
// Auto-generated from AS class Ck_AutoTest_Net_Byte_AlternatingOverrideTracksOnClient (Replicated-mode).
// DO NOT EDIT - regenerated on editor startup and every successful AS recompile.

namespace
{
    constexpr auto kAsClassPath_Byte_AlternatingOverrideTracksOnClient = TEXT("/Script/Angelscript.Ck_AutoTest_Net_Byte_AlternatingOverrideTracksOnClient");
    constexpr auto kTimeoutSeconds_Byte_AlternatingOverrideTracksOnClient = 30.0f;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FCkAttributeNet_AS_Byte_AlternatingOverrideTracksOnClient,
    "Ck.Attribute.Net.AS_Byte_AlternatingOverrideTracksOnClient",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FCkAttributeNet_AS_Byte_AlternatingOverrideTracksOnClient::RunTest(const FString& Parameters)
{
    ...
    ADD_LATENT_AUTOMATION_COMMAND(FCk_Latent_RunAsTestOnAllWorlds(this, FString{kAsClassPath_Byte_AlternatingOverrideTracksOnClient}, kTimeoutSeconds_Byte_AlternatingOverrideTracksOnClient));
