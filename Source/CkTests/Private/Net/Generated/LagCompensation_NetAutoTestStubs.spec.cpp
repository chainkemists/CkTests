...
// Auto-generated from AS class Ck_AutoTest_Net_RewindHistory_RecordsOnAuthorityOnly (Replicated-mode).
// DO NOT EDIT - regenerated on editor startup and every successful AS recompile.

namespace
{
    constexpr auto kAsClassPath_RewindHistory_RecordsOnAuthorityOnly = TEXT("/Script/Angelscript.Ck_AutoTest_Net_RewindHistory_RecordsOnAuthorityOnly");
    constexpr auto kTimeoutSeconds_RewindHistory_RecordsOnAuthorityOnly = 30.0f;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FCkLagCompensationNet_AS_RewindHistory_RecordsOnAuthorityOnly,
    "Ck.LagCompensation.Net.AS_RewindHistory_RecordsOnAuthorityOnly",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FCkLagCompensationNet_AS_RewindHistory_RecordsOnAuthorityOnly::RunTest(const FString& Parameters)
{
    ...
    ADD_LATENT_AUTOMATION_COMMAND(FCk_Latent_RunAsTestOnAllWorlds(this, FString{kAsClassPath_RewindHistory_RecordsOnAuthorityOnly}, kTimeoutSeconds_RewindHistory_RecordsOnAuthorityOnly));
