...
// Auto-generated from AS class Ck_AutoTest_Net_AddTag_Replicates (Replicated-mode).
// DO NOT EDIT — regenerated on editor startup and every successful AS recompile.

namespace
{
    constexpr auto kAsClassPath_AddTag_Replicates = TEXT("/Script/Angelscript.Ck_AutoTest_Net_AddTag_Replicates");
    constexpr auto kTimeoutSeconds_AddTag_Replicates = 30.0f;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FCkTagSetNet_AS_AddTag_Replicates,
    "Ck.TagSet.Net.AS_AddTag_Replicates",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FCkTagSetNet_AS_AddTag_Replicates::RunTest(const FString& Parameters)
{
    ...
    ADD_LATENT_AUTOMATION_COMMAND(FCk_Latent_RunAsTestOnAllWorlds(this, FString{kAsClassPath_AddTag_Replicates}, kTimeoutSeconds_AddTag_Replicates));
