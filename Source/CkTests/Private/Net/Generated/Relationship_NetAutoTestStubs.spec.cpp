...
// Auto-generated from AS class Ck_AutoTest_Net_Team_SetReplicates (Replicated-mode).
// DO NOT EDIT — regenerated on editor startup and every successful AS recompile.

namespace
{
    constexpr auto kAsClassPath_Team_SetReplicates = TEXT("/Script/Angelscript.Ck_AutoTest_Net_Team_SetReplicates");
    constexpr auto kTimeoutSeconds_Team_SetReplicates = 30.0f;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FCkRelationshipNet_AS_Team_SetReplicates,
    "Ck.Relationship.Net.AS_Team_SetReplicates",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FCkRelationshipNet_AS_Team_SetReplicates::RunTest(const FString& Parameters)
{
    bSuppressLogErrors = true;
    bSuppressLogWarnings = true;
    ...
    ADD_LATENT_AUTOMATION_COMMAND(FCk_Latent_RunAsTestOnAllWorlds(this, FString{kAsClassPath_Team_SetReplicates}, kTimeoutSeconds_Team_SetReplicates));
