...
// Auto-generated from AS class Ck_AutoTest_Net_Acceleration_Replicates (Replicated-mode).
// DO NOT EDIT — regenerated on editor startup and every successful AS recompile.

namespace
{
    constexpr auto kAsClassPath_Acceleration_Replicates = TEXT("/Script/Angelscript.Ck_AutoTest_Net_Acceleration_Replicates");
    constexpr auto kTimeoutSeconds_Acceleration_Replicates = 30.0f;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FCkPhysicsNet_AS_Acceleration_Replicates,
    "Ck.Physics.Net.AS_Acceleration_Replicates",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FCkPhysicsNet_AS_Acceleration_Replicates::RunTest(const FString& Parameters)
{
    ...
    ADD_LATENT_AUTOMATION_COMMAND(FCk_Latent_RunAsTestOnAllWorlds(this, FString{kAsClassPath_Acceleration_Replicates}, kTimeoutSeconds_Acceleration_Replicates));
