...
// Auto-generated from AS class Ck_AutoTest_Net_DeferredQueue_PerWorldIsolation (Replicated-mode).
// DO NOT EDIT - regenerated on editor startup and every successful AS recompile.

namespace
{
    constexpr auto kAsClassPath_DeferredQueue_PerWorldIsolation = TEXT("/Script/Angelscript.Ck_AutoTest_Net_DeferredQueue_PerWorldIsolation");
    constexpr auto kTimeoutSeconds_DeferredQueue_PerWorldIsolation = 30.0f;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FCkNavigationNet_AS_DeferredQueue_PerWorldIsolation,
    "Ck.Navigation.Net.AS_DeferredQueue_PerWorldIsolation",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FCkNavigationNet_AS_DeferredQueue_PerWorldIsolation::RunTest(const FString& Parameters)
{
    ...
    ADD_LATENT_AUTOMATION_COMMAND(FCk_Latent_RunAsTestOnAllWorlds(this, FString{kAsClassPath_DeferredQueue_PerWorldIsolation}, kTimeoutSeconds_DeferredQueue_PerWorldIsolation));
