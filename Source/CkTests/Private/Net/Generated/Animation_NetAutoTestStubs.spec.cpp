...
// Auto-generated from AS class Ck_AutoTest_Net_AnimPlan_StateReplicates (Replicated-mode).
// DO NOT EDIT - regenerated on editor startup and every successful AS recompile.

namespace
{
    constexpr auto kAsClassPath_AnimPlan_StateReplicates = TEXT("/Script/Angelscript.Ck_AutoTest_Net_AnimPlan_StateReplicates");
    constexpr auto kTimeoutSeconds_AnimPlan_StateReplicates = 30.0f;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FCkAnimationNet_AS_AnimPlan_StateReplicates,
    "Ck.Animation.Net.AS_AnimPlan_StateReplicates",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FCkAnimationNet_AS_AnimPlan_StateReplicates::RunTest(const FString& Parameters)
{
    ...
    ADD_LATENT_AUTOMATION_COMMAND(FCk_Latent_RunAsTestOnAllWorlds(this, FString{kAsClassPath_AnimPlan_StateReplicates}, kTimeoutSeconds_AnimPlan_StateReplicates));
