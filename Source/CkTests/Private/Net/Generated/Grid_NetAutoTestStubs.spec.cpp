...
// Auto-generated from AS class Ck_AutoTest_Net_Grid_OccupancyReplicates (Replicated-mode).
// DO NOT EDIT — regenerated on editor startup and every successful AS recompile.

namespace
{
    constexpr auto kAsClassPath_Grid_OccupancyReplicates = TEXT("/Script/Angelscript.Ck_AutoTest_Net_Grid_OccupancyReplicates");
    constexpr auto kTimeoutSeconds_Grid_OccupancyReplicates = 30.0f;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FCkGridNet_AS_Grid_OccupancyReplicates,
    "Ck.Grid.Net.AS_Grid_OccupancyReplicates",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FCkGridNet_AS_Grid_OccupancyReplicates::RunTest(const FString& Parameters)
{
    ...
    ADD_LATENT_AUTOMATION_COMMAND(FCk_Latent_RunOnServer(
        FCk_NetAutoTest_ServerAction::CreateLambda([this](UWorld* InServer) -> void
        {
            ...
            const auto SubjectClassPath = FSoftClassPath(TEXT("/Script/CkTests.Ck_AutoTest_NetSubject_Grid_UE"));
    ...
    ADD_LATENT_AUTOMATION_COMMAND(FCk_Latent_RunAsTestOnAllWorlds(this, FString{kAsClassPath_Grid_OccupancyReplicates}, kTimeoutSeconds_Grid_OccupancyReplicates));
