...
// Auto-generated from AS class Ck_AutoTest_Net_OfficeDisplay_RevealedReplicates (Replicated-mode).
// DO NOT EDIT — regenerated on editor startup and every successful AS recompile.

namespace
{
    constexpr auto kAsClassPath_OfficeDisplay_RevealedReplicates = TEXT("/Script/Angelscript.Ck_AutoTest_Net_OfficeDisplay_RevealedReplicates");
    constexpr auto kTimeoutSeconds_OfficeDisplay_RevealedReplicates = 30.0f;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FCkASNet_AS_OfficeDisplay_RevealedReplicates,
    "Ck.AS.Net.AS_OfficeDisplay_RevealedReplicates",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FCkASNet_AS_OfficeDisplay_RevealedReplicates::RunTest(const FString& Parameters)
{
    bSuppressLogErrors = true;
    bSuppressLogWarnings = true;
    ...
    ADD_LATENT_AUTOMATION_COMMAND(FCk_Latent_RunAsTestOnAllWorlds(this, FString{kAsClassPath_OfficeDisplay_RevealedReplicates}, kTimeoutSeconds_OfficeDisplay_RevealedReplicates));
...
// Auto-generated from AS class Ck_AutoTest_Net_WorldCollectible_CollectedReplicates (Replicated-mode).
// DO NOT EDIT — regenerated on editor startup and every successful AS recompile.

namespace
{
    constexpr auto kAsClassPath_WorldCollectible_CollectedReplicates = TEXT("/Script/Angelscript.Ck_AutoTest_Net_WorldCollectible_CollectedReplicates");
    constexpr auto kTimeoutSeconds_WorldCollectible_CollectedReplicates = 30.0f;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FCkASNet_AS_WorldCollectible_CollectedReplicates,
    "Ck.AS.Net.AS_WorldCollectible_CollectedReplicates",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FCkASNet_AS_WorldCollectible_CollectedReplicates::RunTest(const FString& Parameters)
{
    bSuppressLogErrors = true;
    bSuppressLogWarnings = true;
    ...
    ADD_LATENT_AUTOMATION_COMMAND(FCk_Latent_RunAsTestOnAllWorlds(this, FString{kAsClassPath_WorldCollectible_CollectedReplicates}, kTimeoutSeconds_WorldCollectible_CollectedReplicates));
