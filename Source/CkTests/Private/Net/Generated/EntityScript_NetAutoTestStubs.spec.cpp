...
// Auto-generated from AS class Ck_AutoTest_Net_EntityScript_ChildSpawnedInBeginPlayReplicates (Replicated-mode).
// DO NOT EDIT - regenerated on editor startup and every successful AS recompile.

namespace
{
    constexpr auto kAsClassPath_EntityScript_ChildSpawnedInBeginPlayReplicates = TEXT("/Script/Angelscript.Ck_AutoTest_Net_EntityScript_ChildSpawnedInBeginPlayReplicates");
    constexpr auto kTimeoutSeconds_EntityScript_ChildSpawnedInBeginPlayReplicates = 30.0f;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FCkEntityScriptNet_AS_EntityScript_ChildSpawnedInBeginPlayReplicates,
    "Ck.EntityScript.Net.AS_EntityScript_ChildSpawnedInBeginPlayReplicates",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FCkEntityScriptNet_AS_EntityScript_ChildSpawnedInBeginPlayReplicates::RunTest(const FString& Parameters)
{
    ...
    ADD_LATENT_AUTOMATION_COMMAND(FCk_Latent_RunAsTestOnAllWorlds(this, FString{kAsClassPath_EntityScript_ChildSpawnedInBeginPlayReplicates}, kTimeoutSeconds_EntityScript_ChildSpawnedInBeginPlayReplicates));
