...
// Auto-generated from AS class Ck_AutoTest_Net_ObjectPooling_ReplicatedPoolableScriptRecycles (Replicated-mode).
// DO NOT EDIT - regenerated on editor startup and every successful AS recompile.

namespace
{
    constexpr auto kAsClassPath_ObjectPooling_ReplicatedPoolableScriptRecycles = TEXT("/Script/Angelscript.Ck_AutoTest_Net_ObjectPooling_ReplicatedPoolableScriptRecycles");
    constexpr auto kTimeoutSeconds_ObjectPooling_ReplicatedPoolableScriptRecycles = 30.0f;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FCkObjectPoolingNet_AS_ObjectPooling_ReplicatedPoolableScriptRecycles,
    "Ck.ObjectPooling.Net.AS_ObjectPooling_ReplicatedPoolableScriptRecycles",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FCkObjectPoolingNet_AS_ObjectPooling_ReplicatedPoolableScriptRecycles::RunTest(const FString& Parameters)
{
    ...
    ADD_LATENT_AUTOMATION_COMMAND(FCk_Latent_RunAsTestOnAllWorlds(this, FString{kAsClassPath_ObjectPooling_ReplicatedPoolableScriptRecycles}, kTimeoutSeconds_ObjectPooling_ReplicatedPoolableScriptRecycles));
