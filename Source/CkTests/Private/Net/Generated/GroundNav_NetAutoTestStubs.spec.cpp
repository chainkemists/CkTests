...
// Auto-generated from AS class Ck_AutoTest_Net_GroundNav_TwoWorldsDoNotShareFields (Replicated-mode).
// DO NOT EDIT - regenerated on editor startup and every successful AS recompile.

namespace
{
    constexpr auto kAsClassPath_GroundNav_TwoWorldsDoNotShareFields = TEXT("/Script/Angelscript.Ck_AutoTest_Net_GroundNav_TwoWorldsDoNotShareFields");
    constexpr auto kTimeoutSeconds_GroundNav_TwoWorldsDoNotShareFields = 30.0f;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FCkGroundNavNet_AS_GroundNav_TwoWorldsDoNotShareFields,
    "Ck.GroundNav.Net.AS_GroundNav_TwoWorldsDoNotShareFields",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FCkGroundNavNet_AS_GroundNav_TwoWorldsDoNotShareFields::RunTest(const FString& Parameters)
{
    ...
    ADD_LATENT_AUTOMATION_COMMAND(FCk_Latent_RunAsTestOnAllWorlds(this, FString{kAsClassPath_GroundNav_TwoWorldsDoNotShareFields}, kTimeoutSeconds_GroundNav_TwoWorldsDoNotShareFields));
