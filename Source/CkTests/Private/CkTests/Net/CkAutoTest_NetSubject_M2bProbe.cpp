    ...
    ACk_AutoTest_NetSubject_M2bProbe()
{
    ...
    // respawn's OwningActor::Add does NOT re-add the EntityReplicationDriver (which Request_CreateEntity's a
    // driver entity mid-FTSTicker -> EntityJustCreated processor null-deref crash).
