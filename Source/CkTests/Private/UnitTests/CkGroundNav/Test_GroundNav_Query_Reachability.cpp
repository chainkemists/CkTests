...
namespace ck_test_groundnav_query_reachability
{
    ...
    constexpr auto kGroundStoreyMaxZ = 50.0;
    ...
    constexpr auto kNodeWeldUu = 1.0e-3;
    ...
    // ----------------------------------------------------------------------------------------------------------------
    // The reference: an exact Euclidean shortest path in XY over the ground storey, built from the
    // field's own boundary runs and solved with Dijkstra. It shares nothing with the flood fill but the
    // geometry both are describing.
    // ----------------------------------------------------------------------------------------------------------------
     ...
     */
    auto Get_SegmentsProperlyIntersect(
